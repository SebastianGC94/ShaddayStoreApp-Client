...
public class MainActivity extends AppCompatActivity {
    ...
    private void init() {
        ...
        /*txtRecuperarContrasena = findViewById(R.id.txtRecuperarContrasena);*/
                ...
                if (validar()) {
                    viewModel.login(edtMail.getText().toString(), edtPassword.getText().toString()).observe(this, response -> {
                        if (response.getRpta() == 1) {
                            ...
                            toastIncorrecto("Las credenciales no son válidas.");
                        }
                    });
                } else {
    ...
    protected void onStart() {
        ...
        if (!pref.equals("")) {
            toastCorrecto("La sesión sigue activa, el login será omitido.");
    ...
    public void onBackPressed() {
        // Para cerrar la aplicación deslizando o con el botón "atrás"
        // Se debe incluir en InicioActivity
        new SweetAlertDialog(this, SweetAlertDialog.WARNING_TYPE).setTitleText("Presionó el botón  ATRÁS.")
                ...
                .showCancelButton(true).setCancelClickListener(sDialog -> {
                    ...
                    new SweetAlertDialog(this, SweetAlertDialog.ERROR_TYPE).setTitleText("¡Operación cancelada!")
                            .setContentText("No se cerró la aplicación.")
                            .show();
