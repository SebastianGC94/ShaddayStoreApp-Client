...
import static com.shaddaystore_mobileapp_client.utils.Global.OPERACION_CORRECTA;
import static com.shaddaystore_mobileapp_client.utils.Global.RPTA_OK;
import static com.shaddaystore_mobileapp_client.utils.Global.TIPO_DATA;
...
import com.shaddaystore_mobileapp_client.api.PedidoApi;
        ...
        this.api.exportInvoicePDF(idCli, idOrden).enqueue(new Callback<ResponseBody>() {
            ...
            public void onResponse(Call<ResponseBody> call, Response<ResponseBody> response) {
                if(response.isSuccessful()){
                    ...
                    Log.e("exportInvoice", "file received");
                }
            }
